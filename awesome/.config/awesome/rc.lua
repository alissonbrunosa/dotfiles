...
globalkeys = gears.table.join(
    ...
    -- Menubar
    awful.key({ modkey }, "d", function () awful.spawn("appsmenu") end,
    ...
    awful.key({ modkey }, "Print", function () awful.spawn("screenshot window") end,
              {description = "takes a screenshot focused monitor", group = "Utils"}),
    awful.key({ modkey, "Control" }, "Print", function () awful.spawn("screenshot select") end,
              {description = "takes a screenshot cropped area", group = "Utils"})
)
